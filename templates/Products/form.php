...
<fieldset class="mb-4">
    <div class="row gy-4">
        <?= $this->Form->hidden('id')?>
        <div class="col-xl-6 col-md-6"><?=$this->Form->control('name',['label' => 'Nome*', 'require']); ?></div>
        <div class="col-xl-6 col-md-6"><?=$this->Form->control('price',['label' => 'Preço*', 'require']); ?></div>
        ...
        <div class="col-xl-12"><?=$this->Form->control('description',['label' => 'Descrição*', 'require']); ?></div>
    </div>
</fieldset>
