                                        ...
                                        <table class="table align-middle table-nowrap table-hover" id="customerTable">
                                            ...
                                            <tbody class="list form-check-all">
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="collection">
                                                        <div class="d-flex align-items-center">
                                                            <img src="/images/nft/gif/img-1.gif" alt="" class="avatar-xs rounded-circle object-cover me-2"> <a href="apps-nft-item-details" class="link-dark">Patterns Arts & Culture</a>
                                                        </div>
                                                    </td>
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="collection">
                                                        <div class="d-flex align-items-center">
                                                            <img src="/images/nft/gif/img-2.gif" alt="" class="avatar-xs rounded-circle object-cover me-2"> <a href="apps-nft-item-details" class="link-dark">Long-tailed Macaque</a>
                                                        </div>
                                                    </td>
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="collection">
                                                        <div class="d-flex align-items-center">
                                                            <img src="/images/nft/gif/img-5.gif" alt="" class="avatar-xs rounded-circle object-cover me-2"> <a href="apps-nft-item-details" class="link-dark">The Chirstoper</a>
                                                        </div>
                                                    </td>
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="collection">
                                                        <div class="d-flex align-items-center">
                                                            <img src="/images/nft/gif/img-3.gif" alt="" class="avatar-xs rounded-circle object-cover me-2"> <a href="apps-nft-item-details" class="link-dark">Walking On Air</a>
                                                        </div>
                                                    </td>
